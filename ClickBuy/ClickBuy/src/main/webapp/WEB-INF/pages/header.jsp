...
<nav class="navbar navbar-default">
			...
			<li ><a href="${pageContext.request.contextPath}/register"><p class="button">register</p></a></li>
			</security:authorize>
			...
			<a><input class="button" type="submit" value="LOGOUT" ></a></form></p>
			</li>
			</security:authorize>
			<li>
			 <security:authorize access="isAuthenticated()"> <p class="button">Welcome <security:authentication property="principal.username" /></p></security:authorize>
			</li>
			<li>
			 <security:authorize access="isAuthenticated()"> 
       <a href="${pageContext.request.contextPath}/myCart"> <button type="button" class="btn btn-default btn-sm">
          <span  class="glyphicon glyphicon-shopping-cart"></span></button></a></security:authorize>
			</li>			
		</ul>
